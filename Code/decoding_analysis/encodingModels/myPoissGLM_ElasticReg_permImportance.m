function [R2, R2_train, coeff, mdl,R2_importance] = myPoissGLM_ElasticReg_permImportance(X, y, trainVsTest, trainCVfold, alpha, lambdas, permFlag)
...
if permFlag
    ...
    for feature = 1:size(X_test,2)
        for shuff = 1:25
            ...
            R2_importance(feature,shuff) = poissR2(y_test, cvglmnetPredict(mdl,X_shuff, 'lambda_min', 'response'));
